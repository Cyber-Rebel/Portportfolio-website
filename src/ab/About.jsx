...
const About = () => {
  ...
  return (
    <div className="bg-[#1E2125]  text-white min-h-screen py-10 px-6 md:px-20" >
      <div>
        <div style={textcss} className=" about_anima_text  text-[#E9DFCE]    text-[180.6px] ">
  I Can Debug 
 Code 
</div>
<p  style={textcss} className="  text-[#E9DFCE]   text-center  text-[60px]">
 ...
 And
    ...
    <div style={textcss} className="about_anima_text_rev  w-full text-[#E9DFCE] text-end   font-[Grandslang,sans-serif] text-[180.6px]">
 Build Cool Things.
</div>
      </div>

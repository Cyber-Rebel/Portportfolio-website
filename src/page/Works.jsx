...
const Works = () => {
  return (
    // <div className="w bg-gray-950 text-white flex items-center justify-center ">
      <div className="flex w-full h-screen flex-col lg:flex-row  gap-12   bg-gray-900  overflow-hidden p-2 lg:p-12 items-center ">
